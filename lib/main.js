...
module.exports = function(){
    ...
    var _getClickTrackingUrl = function(context){
        ...
        // now add auction data, i.e. fields passed back by exchange containing auction information
        if (context.auctionData){
            url += (context.external ? '&':'?') + serializeObject(context.auctionData);
        }
     ...
     */
    _Loader.prototype.getNativeContext = function(placementSpecs, creativeSpecs, auctionData){
        ...
        context.externalId = creativeSpecs.externalId;

        // finally add whatever auction data was passed through
        context.auctionData = auctionData;
        ...
        xmlHttp.onreadystatechange = function(){
            if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
                ...
                if (!responseJson.default){
                    ...
                    self.auctionData = responseJson.auctionData;
